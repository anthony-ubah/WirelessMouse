...
/* Includes ------------------------------------------------------------------*/
  ...
  /* Uncomment the following line to use the default MOUSE_TIMEOUT_UserCallback()
   function implemented in stm32f4_discovery_MOUSE.c file.
   MOUSE_TIMEOUT_UserCallback() function is called whenever a timeout condition
...
#define MOUSE_FLAG_TIMEOUT         ((uint32_t)0x1000)

/**
  * @brief  MOUSE SPI Interface pins
  */
#define MOUSE_SPI                       SPI1
#define MOUSE_SPI_CLK                   RCC_APB2Periph_SPI1

#define MOUSE_SPI_SCK_PIN               GPIO_PIN_5                  /* PA.05 */
#define MOUSE_SPI_SCK_GPIO_PORT         GPIOA                       /* GPIOA */
#define MOUSE_SPI_SCK_GPIO_CLK          RCC_AHB1Periph_GPIOA
#define MOUSE_SPI_SCK_SOURCE            GPIO_PinSource5
#define MOUSE_SPI_SCK_AF                GPIO_AF5_SPI1

#define MOUSE_SPI_MISO_PIN              GPIO_PIN_6                  /* PA.6 */
#define MOUSE_SPI_MISO_GPIO_PORT        GPIOA                       /* GPIOA */
#define MOUSE_SPI_MISO_GPIO_CLK         RCC_AHB1Periph_GPIOA
#define MOUSE_SPI_MISO_SOURCE           GPIO_PinSource6
#define MOUSE_SPI_MISO_AF               GPIO_AF5_SPI1

#define MOUSE_SPI_MOSI_PIN              GPIO_PIN_7                  /* PA.7 */
#define MOUSE_SPI_MOSI_GPIO_PORT        GPIOA                       /* GPIOA */
#define MOUSE_SPI_MOSI_GPIO_CLK         RCC_AHB1Periph_GPIOA
#define MOUSE_SPI_MOSI_SOURCE           GPIO_PinSource7
#define MOUSE_SPI_MOSI_AF               GPIO_AF5_SPI1

#define MOUSE_SPI_CS_PIN                GPIO_PIN_3                  /* PE.03 */
#define MOUSE_SPI_CS_GPIO_PORT          GPIOE                       /* GPIOE */
#define MOUSE_SPI_CS_GPIO_CLK           RCC_AHB1Periph_GPIOE

#define MOUSE_SPI_INT1_PIN              GPIO_PIN_0                  /* PE.00 */
#define MOUSE_SPI_INT1_GPIO_PORT        GPIOE                       /* GPIOE */
#define MOUSE_SPI_INT1_GPIO_CLK         RCC_AHB1Periph_GPIOE
#define MOUSE_SPI_INT1_EXTI_LINE        EXTI_Line0
#define MOUSE_SPI_INT1_EXTI_PORT_SOURCE EXTI_PortSourceGPIOE
#define MOUSE_SPI_INT1_EXTI_PIN_SOURCE  EXTI_PinSource0
#define MOUSE_SPI_INT1_EXTI_IRQn        EXTI0_IRQn

#define MOUSE_SPI_INT2_PIN              GPIO_PIN_1                  /* PE.01 */
#define MOUSE_SPI_INT2_GPIO_PORT        GPIOE                       /* GPIOE */
#define MOUSE_SPI_INT2_GPIO_CLK         RCC_AHB1Periph_GPIOE
#define MOUSE_SPI_INT2_EXTI_LINE        EXTI_Line1
#define MOUSE_SPI_INT2_EXTI_PORT_SOURCE EXTI_PortSourceGPIOE
#define MOUSE_SPI_INT2_EXTI_PIN_SOURCE  EXTI_PinSource1
#define MOUSE_SPI_INT2_EXTI_IRQn        EXTI1_IRQn
...
*  Default value: 0x21
*******************************************************************************/
#define MOUSE_INFO1              0x0D
/*******************************************************************************
*  INFO2: Device Identification Register
*  Read only register
*  Default value: 0x00
*******************************************************************************/
#define MOUSE_INFO2              0x0E
...
*  Default value: 0x3B
*******************************************************************************/
#define MOUSE_WHO_AM_I_ADDR      0x0F
...
*                1: enable
*******************************************************************************/
#define MOUSE_CTRL_REG6_ADDR     0x25
...
*******************************************************************************/
#define MOUSE_OUT_X_L       	 	 0x28
#define MOUSE_OUT_X_H       	 	 0x29
#define MOUSE_OUT_Y_L       	 	 0x2A
#define MOUSE_OUT_Y_H       	 	 0x2B
#define MOUSE_OUT_Z_L       	 	 0x2C
#define MOUSE_OUT_Z_H       	 	 0x2D
...
*******************************************************************************/
#define MOUSE_FIFO_CTRL_ADDR               0x2E
...
*******************************************************************************/
#define MOUSE_FIFO_SRC_ADDR                0x2F
...
*******************************************************************************/
#define MOUSE_ST1_1_ADDR                   0x40
#define MOUSE_ST1_2_ADDR                   0x41
#define MOUSE_ST1_3_ADDR                   0x42
#define MOUSE_ST1_4_ADDR                   0x43
#define MOUSE_ST1_5_ADDR                   0x44
#define MOUSE_ST1_6_ADDR                   0x45
#define MOUSE_ST1_7_ADDR                   0x46
#define MOUSE_ST1_8_ADDR                   0x47
#define MOUSE_ST1_9_ADDR                   0x48
#define MOUSE_ST1_10_ADDR                  0x49
#define MOUSE_ST1_11_ADDR                  0x4A
#define MOUSE_ST1_12_ADDR                  0x4B
#define MOUSE_ST1_13_ADDR                  0x4C
#define MOUSE_ST1_14_ADDR                  0x4D
#define MOUSE_ST1_15_ADDR                  0x4E
#define MOUSE_ST1_16_ADDR                  0x4F
...
*******************************************************************************/
#define MOUSE_TIM2_1_L_ADDR                0x52 
...
*******************************************************************************/
#define MOUSE_TIM2_1_H_ADDR                0x53 
...
*******************************************************************************/
#define MOUSE_TIM1_1_L_ADDR                0x54
...
*******************************************************************************/
#define MOUSE_TIM1_1_H_ADDR                0x55
...
*******************************************************************************/
#define MOUSE_THRS2_1_ADDR                 0x56
...
*******************************************************************************/
#define MOUSE_THRS1_1_ADDR                 0x57
...
*         1: V- enabled
*******************************************************************************/
#define MOUSE_MASK1_B_ADDR                 0x59
...
*         1: V- enabled
*******************************************************************************/
#define MOUSE_MASK1_A_ADDR                 0x5A
...
*******************************************************************************/
#define MOUSE_ST2_1_ADDR                   0x60
#define MOUSE_ST2_2_ADDR                   0x61
#define MOUSE_ST2_3_ADDR                   0x62
#define MOUSE_ST2_4_ADDR                   0x63
#define MOUSE_ST2_5_ADDR                   0x64
#define MOUSE_ST2_6_ADDR                   0x65
#define MOUSE_ST2_7_ADDR                   0x66
#define MOUSE_ST2_8_ADDR                   0x67
#define MOUSE_ST2_9_ADDR                   0x68
#define MOUSE_ST2_10_ADDR                  0x69
#define MOUSE_ST2_11_ADDR                  0x6A
#define MOUSE_ST2_12_ADDR                  0x6B
#define MOUSE_ST2_13_ADDR                  0x6C
#define MOUSE_ST2_14_ADDR                  0x6D
#define MOUSE_ST2_15_ADDR                  0x6E
#define MOUSE_ST2_16_ADDR                  0x6F
...
*******************************************************************************/
#define MOUSE_TIM2_2_L_ADDR                0x72
...
*******************************************************************************/
#define MOUSE_TIM2_2_H_ADDR                0x73
...
*******************************************************************************/
#define MOUSE_TIM1_2_L_ADDR                0x74
...
*******************************************************************************/
#define MOUSE_TIM1_2_H_ADDR                0x75
...
*******************************************************************************/
#define MOUSE_THRS2_2_ADDR                 0x76
...
*  7:0 THS7-THS0: SM2 Threshold Value
*******************************************************************************/
#define MOUSE_THRS1_2_ADDR                 0x77
...
*         1: V- enabled
*******************************************************************************/
#define MOUSE_MASK2_B_ADDR                 0x79
...
*         1: V- enabled
*******************************************************************************/
#define MOUSE_MASK2_A_ADDR                 0x7A
...
#define MOUSE_DOR									((uint8_t)0x02)
#define MOUSE_DRDY								((uint8_t)0x01)
#define MOUSE_ZYXOR								((uint8_t)0x80)
#define MOUSE_ZOR									((uint8_t)0x40)
#define MOUSE_YOR									((uint8_t)0x20)
#define MOUSE_XOR									((uint8_t)0x10)
#define MOUSE_ZYXDA								((uint8_t)0x08)
#define MOUSE_ZDA									((uint8_t)0x04)
#define MOUSE_YDA									((uint8_t)0x02)
#define MOUSE_XDA									((uint8_t)0x01)
...
/******************************************************************************/
  ...
  * @{
  */
#define MOUSE_SM_ENABLE                   ((uint8_t)0x01)
#define MOUSE_SM_DISABLE                  ((uint8_t)0x00)
/**
  * @}
  */ 
...
/** @defgroup State_Machine_Routed_Interrupt
  * @{
  */
#define MOUSE_SM_INT1                     ((uint8_t)0x00)
#define MOUSE_SM_INT2                     ((uint8_t)0x08)
/**
  * @}
  */ 
...
/** @defgroup Boot_Mode_selection
  * @{
  */
#define MOUSE_BOOT_NORMALMODE              ((uint8_t)0x00)
#define MOUSE_BOOT_FORCED                  ((uint8_t)0x80)
/**
  * @}
  */   
...
/** @defgroup FIFO_Mode_selection 
  * @{
  */
#define MOUSE_FIFO_BYPASS_MODE             ((uint8_t)0x00)
#define MOUSE_FIFO_MODE                    ((uint8_t)0x20)
#define MOUSE_FIFO_STREAM_MODE             ((uint8_t)0x40)
#define MOUSE_FIFO_SF_TRIGGER_MODE         ((uint8_t)0x60)
#define MOUSE_FIFO_BS_TRIGGER_MODE         ((uint8_t)0x80)
#define MOUSE_FIFO_BF_TRIGGER_MODE         ((uint8_t)0xE0)
/**
  * @}
  */

  /** @defgroup STM32F4_DISCOVERY_MOUSE_Exported_Macros
  * @{
  */
#define MOUSE_CS_LOW()       HAL_GPIO_WritePin(MOUSE_SPI_CS_GPIO_PORT, SPI_CS_PIN, GPIO_PIN_RESET)
#define MOUSE_CS_HIGH()      HAL_GPIO_WritePin(MOUSE_SPI_CS_GPIO_PORT, SPI_CS_PIN, GPIO_PIN_SET)
/**
  * @}
  */
...
/** @defgroup STM32F4_DISCOVERY_MOUSE_Exported_Functions
  * @{
  */
void SPI_Init(SPI_InitTypeDef *MOUSEStruct);
